...
import com.vladislav.filestoragerest.dto.AuthenticationRequestDto;
...
public class AuthenticationRestControllerV1 {
    ...
    @PostMapping("login")
    private ResponseEntity<Map<Object, Object>> login(@RequestBody AuthenticationRequestDto requestDto) {
        try {
